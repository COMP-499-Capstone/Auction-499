...
export default function ListingPage() {
  ...
  // 👇 New: buyer navigation to viewer page
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <aside className="w-full lg:w-80 space-y-4">
              ...
              {isSeller && (
                <div className="border rounded-xl p-5 bg-gray-50 shadow-sm space-y-3">
                  ...
                  <p className="text-xs text-gray-600">
                    Start your auction stream for this listing. Share the viewer
                    link with bidders.
                  </p>
              ...
              <div className="border rounded-xl p-5 bg-gray-50 shadow-sm text-sm">
                ...
                {/* Buyer "View Live Stream" button */}
                {!isSeller && (
                  <button
                    type="button"
                    onClick={handleViewLive}
                    className="mt-3 w-full bg-red-600 hover:bg-red-700 text-white font-medium py-2 rounded-md shadow-md flex items-center justify-center gap-2 transition"
                  >
